   /*
      Script xử lý:
      - Lấy dữ liệu giỏ hàng từ localStorage (khóa KHOA) để render tóm tắt
    ...
    */
    ...
    const KHOA = 'gio_demo_v1'; // cùng key với trang giỏ hàng trước đó
    ...
    function validateForm(){
      ...
      if(dienThoai === ''){ 
        ...
        // không hợp lệ (chứa ký tự khác hoặc không đủ/ quá dài)
