        ...
        */
        ...
        // Giỏ hàng: quay lại trang giỏ (thư mục cấp anh/chị để phù hợp cấu trúc)
        document.getElementById('btnGio').addEventListener('click', function () {
            // donHang.html nằm trong thanh-toan/ -> đi lên 1 cấp rồi vào gio-hang/
            window.location.href = '../gio-hang/gioHang.html';
        });

        // Tài khoản: demo (bạn có thể đổi thành link thực tế)
        document.getElementById('btnTK').addEventListener('click', function () {
            alert('Chức năng Tài khoản (demo)');
            // hoặc: window.location.href = '../tai-khoan/taiKhoan.html';
        });
